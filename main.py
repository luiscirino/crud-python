...
b_inserir = Button(frame_baixo, text='Inserir', width=10, font=('Ivy 9 bold'), fg=cor_branca, bg=cor_azul, relief='raised', overrelief='ridge')
b_inserir.place(x=15, y=340)

# Botão atualizar

b_atualizar = Button(frame_baixo, text='Atualizar', width=10, font=('Ivy 9 bold'), fg=cor_branca, bg=cor_verde, relief='raised', overrelief='ridge')
b_atualizar.place(x=115, y=340)

# Botão deletar

b_deletar = Button(frame_baixo, text='Deletar', width=10, font=('Ivy 9 bold'), fg=cor_branca, bg=cor_vermelha, relief='raised', overrelief='ridge')
